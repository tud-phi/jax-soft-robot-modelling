...
if __name__ == "__main__":
    sym_exp_filepath = (
            Path(__file__).parent.parent / "symbolic_expressions" / num_segments_to_filename_map[NUM_SEGMENTS]
    )
    symbolically_derive_planar_pcs_model(num_segments=NUM_SEGMENTS, filepath=sym_exp_filepath)
