...
class PlanarPCS(eqx.Module):
    ...
    def _final_size_jacobian(self, J_full: Array) -> Array:
        ...
        Returns:
            J_active (Array): Jacobian for the active strains of shape (3, num_strains)
        """
        J_active = J_full.transpose(1, 0, 2).reshape(3, self.num_strains)
    ...
    def jacobian_bodyframe(self, q: Array, s: Array) -> Array:
        ...
        Returns:
            J_local (Array): Jacobian of the forward kinematics at point s in the body frame, shape (3, num_dofs)
        """
        _J_local = self._J_local(q, s)
    ...
    def jacobian_inertialframe(self, q: Array, s: Array) -> Array:
        ...
        Returns:
            J_global (Array): Jacobian of the forward kinematics at point s in the inertial frame, shape (3, num_dofs)
        """
        _J_local = self._J_local(q, s)
    ...
    def jacobian_and_derivative_bodyframe(
        ...
        Returns:
            J_local (Array): Jacobian of the forward kinematics at point s in the body frame, shape (3, num_dofs)
            J_d_local (Array): Time-derivative of the Jacobian at point s in the body frame, shape (3, num_dofs)
        """
    ...
    def jacobian_and_derivative_inertialframe(
        ...
        Returns:
            J_global (Array): Jacobian of the forward kinematics at point s in the inertial frame, shape (3, num_dofs)
            J_d_global (Array): Time-derivative of the Jacobian at point s in the inertial frame, shape (3, num_dofs)
        """
