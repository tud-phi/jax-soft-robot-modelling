...
class PCS(eqx.Module):
    ...
    def jacobian_bodyframe_full_fn(self, q: Array, s: Array) -> Array:
        """
    ...
    def jacobian_bodyframe_fn(self, q: Array, s: Array) -> Array:
        ...
        J_local = self.final_size_jacobian(J_local_for_computation) @ self.B_xi
    ...
    def jacobian_inertialframe_fn(self, q: Array, s: Array) -> Array:
        ...
        J_global = self.final_size_jacobian(J_global_for_computation) @ self.B_xi
    ...
    def jacobian_and_derivative_bodyframe_fn(
        ...
        J_local = self.final_size_jacobian(J_local_for_computation) @ self.B_xi
        J_d_local = self.final_size_jacobian(J_d_local_for_computation) @ self.B_xi
    ...
    def jacobian_and_derivative_inertialframe_fn(
        ...
        J_global = self.final_size_jacobian(J_global_for_computation) @ self.B_xi
        J_d_global = self.final_size_jacobian(J_d_global_for_computation) @ self.B_xi
    ...
    def local_mass_matrix(self, i: int) -> Array:
        """
